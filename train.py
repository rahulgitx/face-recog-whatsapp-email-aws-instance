...
print("Model for person 1 trained sucessefully")


#traning second person's model
...
print("Model for person 2 trained sucessefully")
print()
print()
